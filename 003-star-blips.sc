...
c=Crackle;n=(1..28);play{Splay.ar(n.scramble.collect({|i|Ringz.ar(LFPulse.ar(n.choose,0,0.1*i)+c.ar(2,a=0.2)*(c.ar(2,a)+a)*LFSaw.ar(n.choose/(i+1*8)),99*i,a,a)*kr(linen(Env,i,66,n.choose))}),0.8)}
